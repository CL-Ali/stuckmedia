"""
Django settings for stuckmedia project.
...
WSGI_APPLICATION = 'stuckmedia.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'django.log'),  # Adjust the file name as needed
        },
    },
    'loggers': {
        'django': {
